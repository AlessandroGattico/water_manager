...
public class DAO {
	...
	public int addAttuatore(Attuatore attuatore) {
		...
		topic.append("ACTUATOR/");
		topic.append(this.daoAttuatore.getDetails(id));
		
		this.daoAttuatore.addTopic(id, topic.toString());
	...
	public HashSet<Attuatore> getAttuatoriAttiviCampo(int id) {
		HashSet<Attuatore> attuatori = this.daoAttuatore.getAttuatoriCampo(id);
		HashSet<Attuatore> attuatoriAttivi = new HashSet<>();

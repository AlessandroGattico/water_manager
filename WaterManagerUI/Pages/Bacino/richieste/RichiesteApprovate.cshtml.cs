...
namespace WaterManagerUI.Pages.richieste;

public class RichiesteApprovate : PageModel
{
    ...
    public RichiesteApprovate(IHttpClientFactory httpClientFactory, SignInManager<IdentityUser> signInManager)
    {
